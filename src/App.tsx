      ...
      <header className="masthead">
        <div className="masthead__inner">
          ...
          <p className="privacy">
            ...
            Runs entirely in this browser on synthetic records. Nothing is
            uploaded, stored, or sent to any portal.
          </p>
        </div>
      </header>
      ...
      <main className="layout" id="main">
        ...
        <section className="panel" aria-labelledby="ledger-heading">
          ...
          <p className="panel__note">
            Each record is fingerprinted with SHA-256 in this browser, so the
            copy you hold can be shown to be the copy you captured.
          </p>
          <ul className="ledger">
